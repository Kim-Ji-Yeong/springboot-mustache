...
//        List<Hospital> findByPatientRoomCountBetween(int lowerLimit, int upperLimit);
//        List<Hospital> findByPatientRoomCountBetweenOrderByPatientRoomCountDesc(int lowerLimit, int upperLimit);
